    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div class="grid grid-cols-3 gap-8 xl:col-span-3">
          ...
          <div class="md:grid md:grid-cols-2 md:gap-8">
            ...
            <div class="mt-12 md:mt-0">
              ...
              <ul class="mt-4 space-y-4">
                <li v-for="item in navigation.GLM" :key="item.name">
                  <a :href="item.href" class="text-base text-gray-500 hover:text-gray-900">
                    {{ item.name }}
                  </a>
                </li>
      ...
      <div class="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
        ...
        <div class="flex space-x-6 md:order-2">
          ...
          <img class="h-6 w-6 text-white" src="https://discord.com/assets/2d20a45d79110dc5bf947137e9d99b66.svg" />
        </div>
        <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
          &copy; 2021 Golem Factory GmbH, Inc. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
...
const navigation = {
  ...
  Developers: [
    { name: "SDK", href: "#" },
    { name: "Requestor Docs", href: "#" },
    { name: "Test Harness", href: "#" },
    { name: "Github", href: "#" },
  ],
  Community: [
