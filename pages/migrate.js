        ...
        <div className="relative  ">
          <main className="mt-20 mx-auto max-w-7xl px-4 sm:px-6">
            <div className="lg:grid lg:grid-cols-12 lg:gap-8">
              <div className="text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left " data-aos="fade-up" data-aos-duration="1000">
                <h1>
              ...
              <div className="col-span-6 pt-32">
                <h1>
                  ...
                  <span className="mt-1 block text-4xl tracking-tight font-extrabold sm:text-4xl xl:text-6xl">Connecting your wallet</span>
                </h1>
                <p className="mt-3 text-xl text-slate-600 sm:mt-5 ">
              ...
              <div className="col-span-6 pt-32">
                <h1>
                  ...
                  <span className="mt-1 block text-4xl tracking-tight font-extrabold sm:text-4xl xl:text-6xl">Confirm the transaction</span>
                </h1>
                <p className="mt-3 text-xl text-slate-600 sm:mt-5 ">
                  Once you have hit confirm inside of MetaMask, the transaction will be sent to the blockchain and in a minutes time it will
                  be confirmed and your GNT has been migrated to GLM tokens
                </p>
              </div>
