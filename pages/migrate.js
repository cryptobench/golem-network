                            ...
                            <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                                ...
                                >
                                    ...
                                    <p className="mt-3 text-xl text-slate-600 sm:mt-5 ">
                                        Migrate your old GNT to the new token version GLM. Connect your wallet to view your available GNT
                                        balance and start migrating.
                                    </p>
                                    <span className="mt-2 block  text-golemblue font-bold">
                                        Current live cost with 120k gas limit is $11 dollars
                                    </span>
                                    <button className="mt-4 lg:col-span-4 inline-block col-span-6 md:col-span-6 text-center  px-6 py-3 border border-transparent text-sm lg:text-base font-medium rounded-md text-white bg-golemblue shadow-sm hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ">
                                ...
                                <div className="col-span-6 pt-32">
                                    ...
                                    <p className="mt-3 text-xl text-slate-600 sm:mt-5 ">
                                        The first step is to hit the <b>Migrate with MetaMask</b> button above. This will open up your
                                        MetaMask and ask you to connect your wallet. Select the wallet containing your GNT tokens.
                                    </p>
                                </div>
                                ...
                                <div className="col-span-6 pt-32">
                                    ...
                                    <p className="mt-3 text-xl text-slate-600 sm:mt-5 ">
                                        Once you have hit confirm inside of MetaMask, the transaction will be sent to the blockchain and in
                                        a minutes time it will be confirmed and your GNT has been migrated to GLM tokens
                                    </p>
                                </div>
                                ...
                                <div className="col-span-6 pt-32">
                                    ...
                                    <p className="mt-3 text-xl text-slate-600 sm:mt-5 ">
                                        Congratulations, you&apos;ve completed the migration of your GNT tokens to GLM tokens. You can now
                                        use new ERC-20 standard GLM tokens on networks like Polygon to facilitate ultra cheap transactions
                                        and swaps!
                                    </p>
                                </div>
