                    ...
                    <div className="lg:col-span-4 col-span-12 text-center lg:text-left mb-10 lg:mb-0">
                        ...
                        <div className="mt-4 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                            ...
                            <form action="#" method="POST" className="mt-3 sm:flex">
                                ...
                                <button
                                    type="submit"
                                    className="mt-3 w-full px-6 py-3 border border-transparent text-base mb-2font-medium rounded-md text-white bg-golemblue shadow-sm hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:flex-shrink-0 sm:inline-flex sm:items-center sm:w-auto"
                                >
                                    Subscribe
                                </button>
                            </form>
