        ...
        <nav className="relative bggridbottom  w-full h-32 ">
            <Popover className="relative max-w-7xl mx-auto flex items-center justify-between ">
                ...
                <div className="flex justify-end">
                    <button
                        type="submit"
                        className="mt-3 w-full px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-golemblue shadow-sm hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:flex-shrink-0 sm:inline-flex sm:items-center sm:w-auto"
                    >
                        Get Started
                    </button>
                </div>
