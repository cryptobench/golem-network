                    ...
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
                        <div className="sm:max-w-lg">
                            ...
                            <p className="my-4 text-xl inline-block text-slate-600 sm:mt-5 ">
                                The Golem Network is decentralizing the cloud. Join the global supercomputer and earn cryptocurrency like
                                hundreds of others already are.
                            </p>
                                                ...
                                                {foundProviders && foundProviders.length > 0
                                                    ? foundProviders.slice(50, 75).map((user, index) => (
                                                          <div
                                                              ...
                                                              onClick={() => {
                                                                window.open("https://stats.golem.network/network/provider/" + user.node_id)
                                                              }}
                                                              className={
                                                                  "p-6 grid relative text-center cursor-pointer bg-gray-900 rounded-xl w-44 h-64 overflow-hidden " +
                                                                  (index == 1 ? "mt-48" : "")
                                                              }
                                                          >
                                                              ...
                                                              <h5 className="text-white text-xl tracking-tight mb-2 font-medium">
                                                                  {user.data["golem.node.id.name"]}
                                                              </h5>
                                                ...
                                                {foundProviders && foundProviders.length > 0
                                                    ? foundProviders.slice(0, 25).map((user) => (
                                                          <div
                                                              ...
                                                              className="p-6 grid bg-gray-900 cursor-pointer text-center rounded-xl w-44 h-64 overflow-hidden"
                                                          >
                                                              <div className="inline-block relative">
                                                                  <img
                                                                      className="h-20 w-20 rounded-lg shadow-lg mb-2 inline-block"
                                                ...
                                                {foundProviders && foundProviders.length > 0
                                                    ? foundProviders.slice(25, 50).map((user, index) => (
                                                          <div
                                                              ...
                                                              style={{ pointerEvents: "all" }}
                                                              className={
                                                                  "p-6 grid text-center cursor-pointer bg-gray-900 rounded-xl w-44 h-64 overflow-hidden " +
                                                                  (index == 1 ? "mt-48" : "")
                                                              }
                                                          >
                                                              <div className="inline-block relative">
