                        ...
                        >
                            <h1>
                                ...
                                <span className="mt-1 block text-4xl tracking-tight font-extrabold sm:text-4xl xl:text-6xl">
                                    Step into Golem&apos;s Universe!
                                </span>
                            </h1>
                            <p className="mt-3 text-xl text-slate-600 sm:mt-5 ">
                                Allocate 2 minutes and be transported to a new era of computing. Decentralized, profoundly powerful, and
                                meticulously designed for tomorrow&apos;s challenges. Golem is more than a service; it&apos;s a paradigm shift.
                            </p>
                        </div>
