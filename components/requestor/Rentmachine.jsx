                        ...
                        {foundProviders && foundProviders.length > 0 ? (
                            foundProviders.slice(0, 5).map((user) => (
                                <div key={user.node_id} className=" p-6 grid bg-gray-900 rounded-xl">
                                    ...
                                    <span className="text-slate-200 text-lg tracking-tight font-medium mt-1">
                                        0.53 GLM / $0.2 per month
                                    </span>
                                                    ...
                                                    <div className="text-center w-full">
                                                        ...
                                                        <h2 className="text-lg font-medium text-gray-900">
                                                            ...
                                                            {rentProvider.node_id ? (
                                                                <p>{rentProvider.data["golem.node.id.name"]}</p>
                                                            ) : (
                                                                <p>None</p>
                                                            )}
                                                        </h2>
                                                ...
                                                <dl className="mt-2 divide-y divide-gray-200 border-t border-b border-gray-200">
                                                    <div className="flex justify-between py-3 text-sm font-medium">
                                                        ...
                                                        <dd className="text-gray-900">
                                                            {rentProvider.node_id ? (
                                                                <p className="text-sm">{rentProvider.data["golem.inf.cpu.threads"]}</p>
                                                            ) : (
                                                                <p>None</p>
                                                            )}
                                                        </dd>
                                                    ...
                                                    <div className="flex justify-between py-3 text-sm font-medium">
                                                        ...
                                                        <dd className="text-gray-900">
                                                            ...
                                                            {rentProvider.node_id ? (
                                                                <p className="text-sm">
                                                                    {Math.round(rentProvider.data["golem.inf.mem.gib"] * 100) / 100} GB{" "}
                                                                </p>
                                                            ) : (
                                                                <p>None</p>
                                                            )}
                                                    ...
                                                    <div className="flex justify-between py-3 text-sm font-medium">
                                                        ...
                                                        <dd className="text-gray-900">
                                                            ...
                                                            {rentProvider.node_id ? (
                                                                <p className="text-sm">
                                                                    {Math.round(rentProvider.data["golem.inf.storage.gib"] * 100) / 100} GB{" "}
                                                                </p>
                                                            ) : (
                                                                <p>None</p>
                                                            )}
                                                    ...
                                                    <div className="flex justify-between py-3 text-sm font-medium">
                                                        ...
                                                        <dd className="text-gray-900">
                                                            {rentProvider.node_id ? (
                                                                <p>{rentProvider.data["golem.node.debug.subnet"]}</p>
                                                            ) : (
                                                                <p>None</p>
                                                            )}
                                                        </dd>
                                                    ...
                                                    <div className="flex justify-between py-3 text-sm font-medium">
                                                        ...
                                                        <dd className="text-gray-900">
                                                            {rentProvider.node_id ? (
                                                                <p className="text-sm">{rentProvider.version}</p>
                                                            ) : (
                                                                <p>None</p>
                                                            )}
                                                        </dd>
