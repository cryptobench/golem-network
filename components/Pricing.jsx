                ...
                <table className="v-table divide-y-12 divide-gray-900  w-full inline-block lg:table md:table xl:table col-span-12">
                    <thead className="bg-gray-900">
                        <tr>
                            ...
                            <th
                                scope="col"
                                className="px-6 py-5 text-left text-xs font-medium text-white uppercase tracking-wider rounded-r-lg"
                            >
                                Monthly Cost
                            </th>
                        </tr>
                            ...
                            <tr
                                ...
                                onClick={() => {
                                    if (pricing[cores][keyName].name == "Golem Network") {
                                        window.open(
                                            "https://stats.golem.network/network/provider/" + pricing[cores][keyName].node_id,
                                            "_blank"
                                        )
                                    }
                                }}
                            ...
                            >
                                <td className="px-6 py-4 rounded-l-lg">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-4 relative">
                                            {pricing[cores][keyName].name == "Golem Network" ? (
                                                <div className="text-sm font-medium text-gray-900 golemtext ">
                                                    {pricing[cores][keyName].name}{" "}
                                                </div>
                                            ) : (
                                                <div className="text-sm font-medium text-gray-900 golemtext ">
                                                    {pricing[cores][keyName].name}{" "}
                                            ...
                                            {i == 0 ? (
                                                <div className="text-sm text-green-600 font-bold golemtext">
                                                    {Math.round(
                                                        (pricing[cores][1].usd_monthly / pricing[cores][keyName].usd_monthly) * 100
                                                    ) / 100}
                                                    x cheaper
                                                </div>
                                            ) : (
                                                <div className="text-sm text-red-500 font-bold golemtext ">
                                                    {Math.round(
                                                        (pricing[cores][keyName].usd_monthly / pricing[cores][0].usd_monthly) * 100
                                                    ) / 100}
                                                    x expensive
                                                </div>
                                            )}
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    {pricing[cores][keyName].bandwidth == "Unlimited" ? (
                                        ...
                                        <span className="text-sm font-medium text-gray-900 golemtext">
                                            {pricing[cores][keyName].bandwidth} TB
                                        </span>
                                    )}
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium rounded-r-lg">
                                    <span
                                        className={classNames(
                                            i == 0 ? "text-green-600" : "text-rose-600",
                                            "text-xl font-medium  golemtext"
                                        )}
                                    >
