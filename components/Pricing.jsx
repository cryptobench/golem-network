  ...
  return (
    <div className="py-24 mx-auto max-w-7xl px-4 sm:px-6 relative ">
      <div class="grid grid-cols-12 overflow-scroll">
        ...
        <table class="v-table divide-y-12 divide-gray-900  w-full inline-block lg:table md:table xl:table col-span-12">
          <thead className="bg-gray-900">
            <tr>
              <th scope="col" class="px-6 py-5 text-left text-xs font-medium text-white uppercase tracking-wider rounded-l-lg">
                Provider
              </th>
              <th scope="col" class="px-6 py-5 text-left text-xs font-medium text-white uppercase tracking-wider">
                Cores
              </th>
              <th scope="col" class="px-6 py-5 text-left text-xs font-medium text-white uppercase tracking-wider">
                Memory
              ...
              <th class="v-th px-6 py-5 text-left text-xs font-medium text-white uppercase tracking-wider" scope="col">
                <div class="">
                  <span> Bandwidth </span>
                </div>
              </th>
              <th scope="col" class="px-6 py-5 text-left text-xs font-medium text-white uppercase tracking-wider rounded-r-lg">
                Monthly Cost
              </th>
            </tr>
          </thead>
          <tbody className="">
            <tr class="hover:bg-gray-300  cursor-pointer my-12 golemtr">
              <td class="px-6 py-4 rounded-l-lg">
                <div class="flex items-center">
                  <div class="flex-shrink-0 h-12 w-12  rounded-md p-3 relative">
                    <img className="inline-block mr-1" width={48} height={48} alt="do-logo" src="https://i.imgur.com/PSfdKVo.png"></img>
                  </div>
                  <div class="ml-4">
                    <div class="text-sm font-medium text-gray-900 golemtext ">Golem Network</div>
                    <div class="text-sm text-gray-500 golemtext">Available Globally</div>
                  </div>
                </div>
              </td>
            ...
            <tr class="hover:bg-gray-300  cursor-pointer my-12 golemtr">
              <td class="px-6 py-4 rounded-l-lg">
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    <div class="text-sm font-medium text-gray-900 golemtext ">Digital Ocean</div>
                    <div class="text-sm text-gray-500 golemtext">Available Globally</div>
                  </div>
                </div>
              </td>
            ...
            <tr class="hover:bg-gray-300  cursor-pointer my-12 golemtr">
              <td class="px-6 py-4 rounded-l-lg">
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    <div class="text-sm font-medium text-gray-900 golemtext ">Amazon Web Services</div>
                    <div class="text-sm text-gray-500 golemtext">Available Globally</div>
                  </div>
                </div>
              </td>
            ...
            <tr class="hover:bg-gray-300  cursor-pointer my-12 golemtr">
              <td class="px-6 py-4 rounded-l-lg">
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    <div class="text-sm font-medium text-gray-900 golemtext ">Google Cloud Platform</div>
                    <div class="text-sm text-gray-500 golemtext">Available Globally</div>
                  </div>
                </div>
              </td>
