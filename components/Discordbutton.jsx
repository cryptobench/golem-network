...
export default function Button(props) {
  ...
  return open ? (
    <a className="z-50 bottom-2 inline-block fixed right-5 mt-3 text-center  px-6 py-3 border border-transparent text-sm lg:text-base font-medium rounded-lg text-white bg-discordblue shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
      <div
        onClick={() => {
